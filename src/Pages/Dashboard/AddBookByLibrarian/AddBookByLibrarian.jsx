...
const AddBookByLibrarian = () => {
  ...
  const onSubmit = async (data) => {
    ...
    axiosSecure.post("/addedNewBooks", newBookInfo).then((res) => {
      if (res.data.insertedId) {
        reset();
        Swal.fire({
          position: "top-end",
          icon: "success",
          title: "New book has beed added successfully.",
    ...
    <div>
      ...
      <div className="card bg-base-100 w-full max-w-sm mx-auto shrink-0 shadow-2xl">
        <div className="card-body">
          <h2 className="text-center font-bold text-2xl">Added New Book</h2>
          <form onSubmit={handleSubmit(onSubmit)} className="fieldset">
            ...
            />
            {errors.author && (
              <p className="font-bold text-red-500">Author Name is required.</p>
            )}
            {/* Book Title  */}
            ...
            />
            {errors.title && (
              <p className="font-bold text-red-500">Book Title is required.</p>
            )}
            {/* Book Description  */}
...
export default AddBookByLibrarian;
